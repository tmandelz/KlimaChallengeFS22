...
page_Datastory_layout = html.Div([header, html.Div([
				...
				html.Div([
								html.Div([
												html.P("Die Zahl der extremen Hitzeperioden hat in den letzten Jahrzehnten in ganz Europa erheblich zugenommen. Eine Hitzewelle ist ein Zeitraum mit ungewöhnlich heissem Wetter, das über einem Schwellenwert der Referenzperiode zwischen 1979 und 2008 liegt. Die genaue Definition wird auf der Webseite Hintergrundwissen erklärt. In dem Balkendiagramm ist ersichtlich, dass die Anzahl von Hitzetagen bzw. Hitzewellen seit der Jahrtausendwende stark zunimmt."),
												dcc.Graph(figure=create_fig4(), id = "europe_sum_datastory", config = {'displayModeBar': False,'staticPlot': True}),
												html.P(["Hitzewellen treten meist in den Sommermonaten auf. Dies vor allem, weil es in diesen Monaten bereits warm oder sogar heiss ist und die Sonne länger und stärker scheint. Infolge der Speicherung von Wärme durch das freigesetzte Kohlendioxid, wird das Klima zusätzlich angeheizt. Zunehmende Hitzewellen sind nicht die einzige Folge der steigenden Temperaturen, sondern sie wirken sich zusätzlich negativ auf einzelne Regionen und Länder aus. Anhand von vier Beispielen werden die Auswirkungen von Hitzewellen illustriert. ", html.A(
																"Quelle", href="https://journals.ametsoc.org/view/journals/clim/27/10/jcli-d-13-00284.1.xml")])
								]),
								html.Div([
												html.H5("Gesundheit"),
												html.P(["Extreme Hitzewellen haben für die Gesellschaft eine enorme Auswirkung auf die Gesundheit sowie auf die Sterblichkeit. Hier wird spezifisch von einem Hitzetod gesprochen. Dieser wird durch innere Überhitzung des Körpers ausgelöst wird. Die häufigste Ursache dafür sind hohe Temperaturen in Verbindung mit Flüssigkeitsmangel und oder körperliche Anstrengung. ", html.A(
																"Quelle", href="https://www.toppharm.ch/krankheitsbild/hitzetod#:~:text=Unter%20Hitzetod%20verstehen%20Fachleute%20einen,Hitzeersch%C3%B6pfung%2C%20Hitzschlag%20und%20Sonnenstich%20ein."), html.P("Die schlechte Qualität der Infrastruktur und Gesundheitsversorgung, der allgemeine Gesundheitszustand der Bevölkerung sowie die demografische Struktur können ebenso eine Rolle spielen. Der Hitzesommer im Jahre 2003 sorgte dafür, dass sich die Mortalität in Frankreich deutlich erhöhte.")]),
												dcc.Graph(figure=create_fig3(2003,76094), id = "grid1France", config = {'displayModeBar': False,'staticPlot': True}),
												html.P("Als Beispiel wurde hier ein Bereich aus dem südöstlichen Teil von Frankreich im Jahr 2003 gewählt. (lat=44.98188, lon= 5.300815) Die orangen Balken zeigen die Dauer einzelner Hitzewellen. Die letzte Hitzewelle in diesem Jahr dauerte rund zwei Wochen. Während dieser Welle, sie dauerte vom 02.08.2003 bis zum 15.08.2003, starben fast 15'000 Menschen. Dies war ein nationales Trauma für Frankreich. Betroffen waren vornehmlich betagte Menschen, die alleine lebten. Folgende Grafik zeigt auf, wie sich die Anzahl der Toten während dieser Hitzewelle im Sommer 2003 verteilte. Als die extreme Hitze abnahm, ist auch zu sehen, wie sich die Anzahl der Toten rückläufig entwickelte."),
								...
								html.Div([
												...
												html.H6("Abnahme von Ernteerträgen im Jahr 2002/2003"),
												html.Img(src="/assets/fig_crop.png", style={'width':'70%'}),
												html.P("Immerhin könnte der künftige Temperaturanstieg neben den negativen auch positiven Auswirkungen auf die Landwirtschaft haben. So dürften sich in einigen Regionen die Vegetationsperioden verlängern und die Anbaubedingungen sich verbessern. Allerdings wird die Zahl der Extremereignisse, die sich negativ auf die Landwirtschaft in Europa auswirken, zunehmen. Dies hat zur Folge, dass die Sommerkulturen viele Ernteverluste erleiden dürften."),
								...
								html.Div([
												...
												html.P("Hitzewellen haben erhebliche Auswirkungen auf die oben genannten Bereiche, aber hohe Temperaturen bergen auch diverse Nachteile und Risiken im Energiebereich. Beispielsweise müssen energieineffiziente Klimaanlagen immer länger laufen. Solche Temperaturen reduzieren aber auch den Wirkungsgrad von Erdgaskraftwerken, Turbinen und Kesseln. Wasserkraftwerke leiden unter anderem unter Verdunstung und Trockenheit und wärmere Flüsse können AKWs weniger stark kühlen. All dies führt zu geringeren Stromerzeugungen. Die Photovoltaikanlagen wiederum liefern viel Strom. Aber auch diese haben an einem so heissen Tag zu kämpfen. Dies liegt vor allem daran, dass der Wirkungsgrad des Systems mit steigender Temperatur des Moduls abnimmt."),
