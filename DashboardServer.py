...
def showhist():
    ...
    fighist.update_yaxes(minor_ticks="inside", minor_tickmode='array', minor_tickvals=[
                         1, 3, 5, 7, 9, 11], minor_tickcolor="white", minor_tickwidth=1)
...
page_DashBoard_layout = html.Div(
    [header, html.Div(children=[
        ...
        html.Div([
            ...
            html.Div([
                dcc.Graph(figure=create_country_fig("Belgien", 1979, 96097),
                          id="country", config={'displayModeBar': False})
            ], className='six columns')
        ], className='row'),
        html.Div([
            dcc.Slider(
        ...
        html.Div([
            dcc.Graph(figure=create_fig3(1979, 96097), id="grid1",
                      config={'displayModeBar': False})
        ], className='row'),
